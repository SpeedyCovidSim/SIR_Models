...
def main(er_small_test=True, ring_small_test=True):
    ...
    if(ring_small_test):
        ...
        fig = plt.figure()
        plt.plot(t, Ifull, color="red",label="Full",lw = 2, alpha=0.5,figure=fig)
        plt.plot(t, I4, color="blue",label="K = 40",lw = 2, alpha=0.5,figure=fig)
        plt.plot(t, I2, color="green",label="K = 20",lw = 2, alpha=0.5,figure=fig)
        plt.plot(t, I1, color="yellow",label="K = 10",lw = 2, alpha=0.5,figure=fig)
        plt.plot(t, I05, color="black",label="K = 5",lw = 2, alpha=0.5,figure=fig)
        plt.plot(t, I02, color="orange",label="K = 2",lw = 2, alpha=0.5,figure=fig)
        plt.legend()
        plt.xlabel("Time")
        plt.ylabel("Number of Infected Individuals")
