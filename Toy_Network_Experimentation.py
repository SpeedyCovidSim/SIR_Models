...
def main(single_lattices=True, multi_lattices=True,k_random=True,k_workplace=True):
    ...
    if(k_random):
        ...
        plt.xlabel("Time", fontsize=20)
        plt.ylabel("Number of Individuals in State", fontsize=16)
        plt.title(f"SIR model with {N} households of {n} people, \n {k} random links between households", fontsize=20)
        ...
        plt.xlabel("Time", fontsize=20)
        plt.ylabel("Number of Infected Individuals", fontsize=16)
        plt.title(f"SIR model of neighbourhoods with varying random links", fontsize=20)
    ...
    if(k_workplace):
        ...
        plt.xlabel("Time", fontsize=20)
        plt.ylabel("Number of Individuals in State", fontsize=16)
        plt.title(f"SIR model with {N} households of {n} people, \n {k} workplace links between households", fontsize=20)
        ...
        plt.xlabel("Time", fontsize=20)
        plt.ylabel("Number of Infected Individuals", fontsize=16)
        plt.title(f"SIR model of neighbourhoods with varying workplace links", fontsize=20)
