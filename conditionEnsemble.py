...
def conditionABC(dir):
    ...
    data = np.array([[1, 10, 20, 32, 51, 74, 107, 148, 210, 278, 348, 430, 513, 566, 615, 690, 739, 767, 787, 807, 827, 848, 863, 876]])
    ...
    # for i in indexes[1]:
    #     plt.plot(list(range(0, len(conf_cases[i]))), conf_cases[i], "r*", lw=1, alpha = 0.2)
...
DF.to_csv('/Users/joeltrent/Documents/GitHub/SIR_Models/August2021Outbreak/CSVOutputs/indexes_ensemble_config_11_11Sep_ABC.csv', header=False, index=False)
