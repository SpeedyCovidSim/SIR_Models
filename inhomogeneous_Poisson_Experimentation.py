...
from PythonSimulation.simulate import nH_single_simulation, nH_competing_simulation

def main(single=True, competing=True):
    '''
    ...
    if (competing):
        ...
        title = f"Inv., First Max., Gillespie Max., and nMGA Methods for competing inhomogeneous Poissons"
