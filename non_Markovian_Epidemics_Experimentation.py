...
def main(non_SIR=True, non_SEIR=True):
    '''
    ...
    if (non_SIR):
        ...
        fig = plt.figure()
        plt.plot(t, Ifullm, color="red",label="Full - Markov.",lw = 2, alpha=0.5,figure=fig)
        plt.plot(t, Ifullnms, color="red",linestyle="dashed",label="Full - nMarkov.",lw = 2, alpha=0.5,figure=fig)
        plt.plot(t, I5m, color="blue",label="P = 0.005 - Markov.",lw = 2, alpha=0.5,figure=fig)
        plt.plot(t, I5nms, color="blue",linestyle="dashed",label="P = 0.005  - nMarkov.",lw = 2, alpha=0.5,figure=fig)
        plt.plot(t, I3m, color="green",label="P = 0.003 - Markov.",lw = 2, alpha=0.5,figure=fig)
        plt.plot(t, I3nms, color="green",linestyle="dashed",label="P = 0.003 - nMarkov.",lw = 2, alpha=0.5,figure=fig)
        plt.plot(t, I1m, color="orange",label="P = 0.001 - Markov.",lw = 2, alpha=0.5,figure=fig)
        plt.plot(t, I1nms, color="orange",linestyle="dashed",label="P = 0.001 - nMarkov.",lw = 2, alpha=0.5,figure=fig)
        plt.legend()
        plt.xlabel("Time")
        plt.ylabel("Number of Infected Individuals")
        plt.title(f"Markov. vs Non-Markov. with varying probabilities of arcs existing")
        ...
        plt.plot(t, Ifullnms, color="red",linestyle="dotted",label="Full - Strong nMarkov.",lw = 2, alpha=0.5,figure=fig)
        plt.plot(t, I5m, color="blue",label="P = 0.005 - Markov.",lw = 2, alpha=0.5,figure=fig)
        plt.plot(t, I5nm, color="blue",linestyle="dashed",label="P = 0.005  - Weak nMarkov.",lw = 2, alpha=0.5,figure=fig)
        plt.plot(t, I5nms, color="blue",linestyle="dotted",label="P = 0.005  - Strong nMarkov.",lw = 2, alpha=0.5,figure=fig)
        plt.plot(t, I3m, color="green",label="P = 0.003 - Markov.",lw = 2, alpha=0.5,figure=fig)
        plt.plot(t, I3nm, color="green",linestyle="dashed",label="P = 0.003 - Weak nMarkov.",lw = 2, alpha=0.5,figure=fig)
        plt.plot(t, I3nms, color="green",linestyle="dotted",label="P = 0.003 - Strong nMarkov.",lw = 2, alpha=0.5,figure=fig)
        plt.plot(t, I1m, color="orange",label="P = 0.001 - Markov.",lw = 2, alpha=0.5,figure=fig)
        plt.plot(t, I1nm, color="orange",linestyle="dashed",label="P = 0.001 - Weak nMarkov.",lw = 2, alpha=0.5,figure=fig)
        plt.plot(t, I1nms, color="orange",linestyle="dotted",label="P = 0.001 - Strong nMarkov.",lw = 2, alpha=0.5,figure=fig)
        plt.legend()
        plt.xlabel("Time")
        plt.ylabel("Number of Infected Individuals")
        plt.title(f"Markov. vs Non-Markov. with varying probabilities of arcs existing")
